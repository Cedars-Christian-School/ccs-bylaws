...
\addcontentsline{toc}{subsection}{1.3 Limitations on Earnings}
...
\addcontentsline{toc}{subsection}{1.4 Limitation on Political Activities}
...
\addcontentsline{toc}{subsection}{1.5 Other Limitations on Activities}
...
\addcontentsline{toc}{section}{2. Members}

\subsection*{2.1 Members}\label{members-1}
\addcontentsline{toc}{subsection}{2.1 Members}
...
\addcontentsline{toc}{subsection}{2.2 Membership Certificates}
...
\addcontentsline{toc}{subsection}{2.3 Duration of Membership; Resignation}
...
\addcontentsline{toc}{subsection}{2.4 Dues, Fees, and Assessments}
...
\addcontentsline{toc}{section}{3. Meetings of Members}

\subsection*{3.1 Annual Meeting of the Members}\label{annual-meeting-of-the-members}
\addcontentsline{toc}{subsection}{3.1 Annual Meeting of the Members}
...
\addcontentsline{toc}{subsection}{3.2 Regular Members Meetings}
...
\addcontentsline{toc}{subsection}{3.3 Special Members Meetings}
...
\addcontentsline{toc}{subsection}{3.4 Notice of Members Meetings}
...
\addcontentsline{toc}{subsection}{3.5 Members Quorum and Voting}
...
\addcontentsline{toc}{subsection}{3.6 Voting List}
...
\addcontentsline{toc}{subsection}{3.7 No Voting by Proxy}
...
\addcontentsline{toc}{subsection}{3.8 Members Meeting by Remote Communications Technology}
...
\addcontentsline{toc}{subsection}{3.9 Director Removal; Vacancy}
...
\addcontentsline{toc}{subsection}{3.10 Ultimate Authority and Interpretation}
...
\addcontentsline{toc}{subsection}{3.11 Member Compensation}
...
\addcontentsline{toc}{subsection}{3.12 Action by Consent}
...
\addcontentsline{toc}{section}{4. Board of Directors}

\subsection*{4.1 General Powers}\label{general-powers}
\addcontentsline{toc}{subsection}{4.1 General Powers}
...
\addcontentsline{toc}{subsection}{4.2 Qualifications of Directors}
...
\addcontentsline{toc}{subsection}{4.3 Election and Term}
...
\addcontentsline{toc}{subsection}{4.4 Class}
...
\addcontentsline{toc}{subsection}{4.5 Number of Directors}
...
\addcontentsline{toc}{subsection}{4.6 Board Meetings}
...
\addcontentsline{toc}{subsection}{4.7 Annual Meeting}
...
\addcontentsline{toc}{subsection}{4.8 Special Meeting}
...
\addcontentsline{toc}{subsection}{4.9 Quorum}
...
\addcontentsline{toc}{subsection}{4.10 Voting}
...
\addcontentsline{toc}{subsection}{4.11 Meeting by Remote Communications Technology}
...
\addcontentsline{toc}{subsection}{4.12 Action Without Meetings}
...
\addcontentsline{toc}{subsection}{4.13 Notice}
...
\addcontentsline{toc}{subsection}{4.14 Director Compensation}

Directors as such will not receive any compensation for their services as Directors, but by resolution of the Board may be reimbursed for their expenses of attendance at meetings of the Board; provided, that nothing herein contained will be construed to preclude any Director from serving the Corporation in any other capacity and receiving reasonable compensation for personal services actually rendered. The Corporation shall not loan money or property to, or guarantee the obligation of, any Director.

\subsection*{4.15 Resignation}\label{resignation}
\addcontentsline{toc}{subsection}{4.15 Resignation}

A Director may resign at any time by delivering a written resignation to the Moderator of the Members. Such resignation will be effective upon receipt unless it is specified to be effective at some other time or upon the happening of some other event.

\subsection*{4.16 Removal}\label{removal}
\addcontentsline{toc}{subsection}{4.16 Removal}

The Board may recommend to the Members a Director's removal. If a Director proposes that another Director be removed, written notice of the proposal shall be given to that Director at least ten days before the meeting at which a recommendation of removal will be considered. If a majority of the Board votes to recommend removal, the Session will be notified of the recommendation.

\section*{5. Committees of the Board}\label{committees-of-the-board}
\addcontentsline{toc}{section}{5. Committees of the Board}

The Board, by resolution adopted by a majority of the Directors in office, may designate and appoint one or more committees of the Board. Each such committee need not be composed entirely of directors. Provided, however, that if a committee is to exercise board powers, functions, or authority, (a)~all the persons serving on the committee must be directors, (b)~there must be at least three persons on the committee, and (c)~the creation of the committee and the appointment of its members shall be by a majority of all directors in office when the action is taken. A majority of the whole committee will constitute a quorum and the act of a majority of the members present at a meeting at which a quorum is present will be the act of the committee.

\section*{6. Officers}\label{officers}
\addcontentsline{toc}{section}{6. Officers}

\subsection*{6.1 Elected Officers}\label{elected-officers}
\addcontentsline{toc}{subsection}{6.1 Elected Officers}
...
\addcontentsline{toc}{subsection}{6.2 Duties of Moderator of the Board}
...
\addcontentsline{toc}{subsection}{6.3 Duties of President/Principal}
...
\addcontentsline{toc}{subsection}{6.4 Duties of Secretary}
...
\addcontentsline{toc}{subsection}{6.5 Duties of Treasurer}
...
\addcontentsline{toc}{subsection}{6.6 Resignation and Removal}
...
\addcontentsline{toc}{subsection}{6.7 Vacancies}
...
\addcontentsline{toc}{subsection}{6.8 Compensation}
...
\addcontentsline{toc}{section}{7. Teachers and Administrators}
...
\addcontentsline{toc}{subsection}{7.1 Qualifications of Teachers, Teacher's Aides, and Administrators}
...
\addcontentsline{toc}{subsection}{7.2 Dismissal of a Teacher or Teacher's Aide}
...
\addcontentsline{toc}{section}{8. Students}

\subsection*{8.1 Qualifications of Students}\label{qualifications-of-students}
\addcontentsline{toc}{subsection}{8.1 Qualifications of Students}
...
\addcontentsline{toc}{subsection}{8.2 Expulsion}
...
\addcontentsline{toc}{subsection}{8.3 Parents Acknowledge Christian Education}
...
\addcontentsline{toc}{section}{9. General Provisions}

\subsection*{9.1 Contracts}\label{contracts}
\addcontentsline{toc}{subsection}{9.1 Contracts}
...
\addcontentsline{toc}{subsection}{9.2 Loans}
...
\addcontentsline{toc}{subsection}{9.3 Checks, Drafts, and Similar Instruments}
...
\addcontentsline{toc}{subsection}{9.4 Deposits}
...
\addcontentsline{toc}{subsection}{9.5 Custodians}
...
\addcontentsline{toc}{subsection}{9.7 Corporate Seal}
...
\addcontentsline{toc}{subsection}{9.8 Fiscal Year}
...
\addcontentsline{toc}{subsection}{9.9 Interpretation}
...
\addcontentsline{toc}{subsection}{9.10 Limitation on Liability and Indemnification}
...
\addcontentsline{toc}{subsection}{9.11 Property Devoted to Corporate Purposes}
...
\addcontentsline{toc}{section}{10. Amendments to the Bylaws}
